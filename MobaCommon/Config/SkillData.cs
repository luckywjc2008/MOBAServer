...
namespace MobaCommon.Config
{
    ...
    public class SkillData
    {
        ...
        static SkillData()
        {
            CreateSkill(1001,"技能1","我天生的第一个技能",
            ...
            CreateSkill(1002, "技能2", "我天生的第二个技能", 
                new SkillLevelDataModel(1, 0, 0, 0, 0),
                new SkillLevelDataModel(3, 7, 60, 20, 10),
                new SkillLevelDataModel(5, 6, 70, 25, 10),
                new SkillLevelDataModel(9, 5, 80, 30, 10),
                new SkillLevelDataModel(-1, 4, 90, 40, 10));
            CreateSkill(1003, "技能3", "我天生的第三个技能", 
                new SkillLevelDataModel(1, 0, 0, 0, 0), 
                new SkillLevelDataModel(3, 7, 60, 20, 10),
                new SkillLevelDataModel(5, 6, 70, 25, 10),
                new SkillLevelDataModel(9, 5, 80, 30, 10),
            ...
            CreateSkill(1004, "必杀技", "不放则以，放则秒杀", 
                ...
                new SkillLevelDataModel(-1, 80, 150, 150, 10));
        }

        public static SkillDataModel GetSkllData(int id)
        {
        ...
        private static void CreateSkill(int id, string name, string desc,params SkillLevelDataModel[] lvModels)
        {
            SkillDataModel data = new SkillDataModel(id,name,desc,lvModels);
            //保存到字典
    ...
    public class SkillDataModel
    {
        ...
        public SkillDataModel(int id,string name,string desc,SkillLevelDataModel[] lvModels)
        {
            this.Id = id;
            this.Name = name;
